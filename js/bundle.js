...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Game, { cells: 9 }), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = React.createClass({
	  ...
	  renderItem: function renderItem(item, index) {
	    ...
	    return React.createElement("div", { key: item, onClick: this.clicked.bind(this, index), className: cls });
	  },
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      null,
	      React.createElement(Timer, { timeout: 2, onTimeout: this.timeout }),
